//____________________________________________________________ BtUpload.h                                     
#pragma once
#include "resource.h"
//To create an object of this class, you must insert a Custom Control in the GUI

class BtUpload: public Win::Window
{
public:
	BtUpload();
	~BtUpload();
...
private:
	const wchar_t * GetClassName(void){return L"BtUpload";}
